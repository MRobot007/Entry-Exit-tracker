...
const GOOGLE_APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbycAjs-VjZDGLjGRZuLtZ-Llow7JjLhmww3OfTWSKYJUbwlwTJG-Em9PwSME1_bTKwO2w/exec';
...
class GoogleSheetsDB {
  ...
  // Define per-course/branch entry sheets
  ...
  async initializeSheets() {
    try {
      ...
      // Ensure per-course/branch entry sheets exist
